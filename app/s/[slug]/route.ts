...
const BOT_USER_AGENTS = ['facebookexternalhit', 'Facebot', 'twitterbot', 'X-Twitter', 'LinkedInBot', 'Slackbot', 'WhatsApp', 'TelegramBot', 'Discordbot', 'bot', 'crawler', 'preview', 'meta-externalagent'];
...
<body style="font-family: system-ui; padding: 40px; text-align: center;">
    ...
    <img src="${preview.image}" alt="${preview.title}" style="max-width: 100%; border-radius: 12px;" />
    <p style="margin-top: 40px; color: #666; font-size: 0.9rem;">
      This preview is optimized for social media.<br>
      <strong>Real users are redirected instantly.</strong>
    </p>
</body>
</html>`;
}
